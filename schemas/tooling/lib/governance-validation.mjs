...
const ADR_FILES_BY_VERSION = { "1.0.0": Object.keys(ADRS).slice(0, 5), "1.1.0": Object.keys(ADRS), "1.2.0": Object.keys(ADRS), "1.3.0": Object.keys(ADRS) };
...
export function validateOwnershipMatrix(matrix) {
  ...
  if (!/^(?:1\.0\.0|1\.1\.0|1\.2\.0|1\.3\.0)$/.test(matrix.contract_version)) throw new Error("Ownership matrix must define a supported contract version");
