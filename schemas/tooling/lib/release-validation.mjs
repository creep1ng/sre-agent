...
const PREVIOUS_RELEASE = { "1.1.0": "1.0.0", "1.2.0": "1.1.0", "1.3.0": "1.2.0", "1.4.0": "1.3.0", "2.0.0": "1.4.0" };
const baseline = (version) => version === "1.0.0" ? { previous_release: null, previous_major: null, compatibility: "initial-publication" } : version === "2.0.0" ? { previous_release: "1.4.0", previous_major: "1.0.0", compatibility: "breaking" } : PREVIOUS_RELEASE[version] ? { previous_release: PREVIOUS_RELEASE[version], previous_major: "1.0.0", compatibility: "additive" } : null;
