...
const CONSUMERS = ["issue-10", "issue-11", "issue-13", "issue-14", "harness", "ui"], consumersForVersion = (version) => version === "2.1.0" ? [...CONSUMERS, "issue-130"] : CONSUMERS;
const POLICY = {
  ...
  "issue-130": ["release", "issue-130.consumption-contract", "consumption-contract", "fixtures/positive/consumption.states.positive.v2.1.0.fixture.json"]
};
const command = (consumer) => consumer === "issue-130" ? `npm --prefix schemas/tooling run conformance -- --consumer ${consumer} --release 2.1.0` : `npm --prefix schemas/tooling run conformance -- --consumer ${consumer}`;
...
const PREVIOUS_RELEASE = { "1.1.0": "1.0.0", "1.2.0": "1.1.0", "1.3.0": "1.2.0", "1.4.0": "1.3.0", "2.0.0": "1.4.0", "2.1.0": "2.0.0" };
