...
const versions = /^(?:1\.0\.0|1\.1\.0|1\.2\.0|1\.3\.0|1\.4\.0|2\.0\.0|2\.1\.0|2\.2\.0|2\.3\.0|2\.4\.0)$/;
...
try {
  ...
  else { console.error("Usage: node release.mjs projection|evidence|validate --release 1.0.0|1.1.0|1.2.0|1.3.0|1.4.0|2.0.0|2.1.0|2.2.0|2.3.0|2.4.0 | validate-all | conformance --check coverage | conformance --consumer <id> [--release <version>]"); process.exitCode = 2; }
