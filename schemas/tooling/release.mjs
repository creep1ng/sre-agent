...
try {
  ...
  else { console.error("Usage: node release.mjs projection|evidence|validate --release 1.0.0|1.1.0|1.2.0|1.3.0|1.4.0 | conformance --check coverage | conformance --consumer <id>"); process.exitCode = 2; }
