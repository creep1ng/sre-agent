...
- [ ] 1.2 Add failing audit/DTO/projection/migration tests in `tests/test_governance_dto.py`, `tests/test_audit.py`, `tests/test_persistence_projections.py`, and `tests/test_migrations.py` for nullable historical causes, closed values, stage/decision consistency, invalid-row checks, and 1.3 readback.
