...
lifecycle controls, dos sesiones); convergencia real entre sesiones
recreadas, contra PostgreSQL, en `tests/test_incident_query_timeline.py`
(#189). Renders reales de resumen y 403 capturados en verificación para
evidencia de revisión. Lógica viva contra PG verificada en desarrollo
(detalle 200, timeline seq 0-2, snapshot v1/seq0).
